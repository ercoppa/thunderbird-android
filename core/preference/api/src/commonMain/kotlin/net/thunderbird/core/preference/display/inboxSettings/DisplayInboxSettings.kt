...
const val DISPLAY_SETTINGS_DEFAULT_IS_CONVERSATION_VIEW_ENABLED = true
...
data class DisplayInboxSettings(
    ...
    val isConversationViewEnabled: Boolean = DISPLAY_SETTINGS_DEFAULT_IS_CONVERSATION_VIEW_ENABLED,
)
